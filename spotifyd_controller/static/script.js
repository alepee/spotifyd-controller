...
class API {
    ...
    refreshRegistry = () => {
        ...
        this.request('/api/registry/', false, callback)
    }
    ...
    refreshActionClasses = () => {
        ...
        this.request('/api/action-classes/', false, callback)
    }
    ...
    register = () => {
        ...
        this.request('/api/register/', data, this.formCallback)
    }
    ...
    unregister = () => {
        let form = document.getElementById('register-form')
        let data = new FormData(form)
        this.request('/api/unregister/', data, this.formCallback)
    }
    ...
    getLatestTag = () => {
        ...
        let do_request = () => {
            ...
            api.request('/api/latest/', false, callback)
        }
